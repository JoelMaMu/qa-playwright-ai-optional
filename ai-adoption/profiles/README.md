...
Pick yours with [`docs/ai-posture.md`](../README.md).
...
**Read that last column carefully.** Every spec in `qa-automation/tests/` was written under
...
> Egress at execution: none. The suite is identical. Deleting `ai-engineering/` changes
