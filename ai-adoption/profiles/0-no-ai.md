...
**This is what the suite in `qa-automation/tests/` uses.** Every spec here was written by hand,
...
(`qa-automation/tests/fixtures/egress-guard.ts`) blocks and records any request that is not
