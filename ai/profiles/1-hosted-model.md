...
- tool allowlist on the **client** side, `ai/policy/mcp-client-allowlist.json`;
- container on the `internal: true` network, no outbound route;
- prompts from `ai/prompts/`, versioned and reviewed like code.
...
[`docs/threat-model.md`](../../docs/threat-model.md), section 5.
